...
// A função abaixo recebo por parâmetro  o ano atual, o ano de nascimento de uma
// pessoa, e o ano em que sua carteira de identidade foi emitida(nessa ordem).
//   A função retorna  uma string que indica se a carteira precisa ser renovada
...
// código inserido
// npm run startExer5 2022 1992 2018
// retorno
