...
describe("Testando a UserBusiness", () => {
    ...
    test("Teste de erro quendo a senha for menor que 6 caracteres", async () => {
        expect.assertions(2)
        try {
            const input: ISignupInputDTO = {
                email: "fulano@gmail.com",
    ...
    test("Teste de quando o name for menor que seis caracteres", async () => {
        expect.assertions(2)
        try {
            const input: ISignupInputDTO = {
                email: "fulano@gmail.com",
    ...
    test("Teste o erro de quando a senha for menor que seis caracteres", async () => {
        expect.assertions(2)
        try {
            const input: ILoginInputDTO = {
                email: "astrodev@gmail.com",
    ...
    test("Teste o erro email email @", async () => {
        expect.assertions(2)
        try {
            const input: ILoginInputDTO = {
